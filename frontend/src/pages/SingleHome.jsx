...
const SingleHome = () => {
  return (
    <div dir="rtl">
      <div>
        <h1 className="my-6 text-xl font-semibold">خانه آپرتمانی سه طبقه</h1>
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 [direction:ltr]">
          ...
          <div className="grid-cols-2 gap-3 grid relative">
            ...
            <span className="absolute bottom-5 right-4 px-3 py-1 rounded-md border-gray-700 cursor-pointer border-2 bg-white">نشان دادن تمام عکس ها 19</span>
          </div>
        </div>
