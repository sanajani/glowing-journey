...
const ImageGridDesktop = () => {
  return (
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 [direction:ltr]">
          <div className="w-full">
            <ImageContainer className='h-[400px]' imageUrl={imageaddress} title='house for rent' />
          </div>
          <div className="grid-cols-2 gap-3 grid relative">
            <ImageContainer className='h-48' imageUrl={imageaddress4} title='house for rent' />
            <ImageContainer className='h-48' imageUrl={imageaddress1} title='house for rent' />
            <ImageContainer className='h-48' imageUrl={imageaddress2} title='house for rent' />
            <ImageContainer className='h-48' imageUrl={imageaddress3} title='house for rent' />
